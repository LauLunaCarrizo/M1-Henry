...
if(this.buckets[place]===undefined){
  const newObj = {}
  newObj[key]=[val1]
  this.buckets[place]=newObj;
}
this.buckets[place][key]= value;
return this.buckets;
};
HashTable.prototype.get = function (key) {
  let place = this.hash(key)
  if(this.buckets[place] && this.buckets[place][key]){
    return this.buckets[place][key];
  }
};
